<script>
    import { Button, Card, Label, Input, ButtonGroup, InputAddon, ToolbarButton } from 'flowbite-svelte';
    let showPassword = false;
</script>

<div class="w-screen h-screen flex overflow-y-auto">
    ...
    <div class="w-full max-[900px]:bg-primary min-[901px]:bg-gray-200 p-4">
        <Card class="relative m-auto top-1/2 -translate-y-1/2 overflow-y-auto">
            ...
            <Label class="space-y-2 mt-4">
                <span>Password</span>
                <Input type={showPassword ? 'text' : 'password'} placeholder="Enter your password" size="md">
            ...
            <Button type="submit" class="mt-6 uppercase" color="green">Confirm</Button>
        </Card>
    </div>
</div>
