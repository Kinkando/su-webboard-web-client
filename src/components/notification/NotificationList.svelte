...
<section class="relative min-w-[330px] max-w-sm">
    ...
    {/each}
    <a class="flex items-center py-2 justify-center ease-in duration-150 transition-colors bg-gray-200 dark:bg-gray-900 hover:bg-gray-300 dark:hover:bg-gray-600" href="/notification">
