...
{:else}
    <div class="w-fit py-1 px-2 rounded-md text-xs text-black text-center overflow-hidden text-ellipsis whitespace-nowrap min-w-[40px] hover:cursor-default" style="background-color: {categoryHexColor}">
        {categoryName}
    </div>
{/if}